...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget textViewWidgetDisplayer(
      String errormessage,
      String hintname,
      ...
      return MaterialButton(
        ...
        onPressed: () async {
          ...
          if (_formkey.currentState.validate()) {
            ...
            print(password.text);
            dynamic result =
                await Registration().registerNewUser(emailId.text, {
                ...
                builder: (BuildContext context) {
                  ...
                  return Column(
                    children: <Widget>[
                      ...
                      textViewWidgetDisplayer('Cant be empty', 'E-mail ID',
                          TextCapitalization.none, TextInputType.text, emailId),
